...
def plot_decision_boundary(model, X, y, epoch, filename):
    ...
    # Add the true decision boundary lines
    # Line 1: P/E = 15 for x2 < 1.2
    x1_line1 = np.array([15, 15])
    x2_line1 = np.array([0, 1.2])
    plt.plot(x1_line1, x2_line1, "b-", linewidth=2.5, label="True Decision Boundary")

    # Line 2: Debt-to-Equity = 1.2 for P/E < 15
    x1_line2 = np.array([5, 15])
    x2_line2 = np.array([1.2, 1.2])
    plt.plot(x1_line2, x2_line2, "b-", linewidth=2.5)

    # Line 3: P/E = 25 vertical line
    x1_line3 = np.array([25, 25])
    x2_line3 = np.array([0, 2.5])
    plt.plot(x1_line3, x2_line3, "b-", linewidth=2.5)

    # Line 4: Debt-to-Equity = 0.5 for P/E between 15 and 25
    x1_line4 = np.array([15, 25])
    x2_line4 = np.array([0.5, 0.5])
    plt.plot(x1_line4, x2_line4, "b-", linewidth=2.5)
    ...
    # Add the true boundary to legend
    legend_elements.append(
        plt.Line2D([0], [0], color="blue", lw=2.5, label="True Decision Boundary")
    )
